...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import LAME_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("c1c5ebd0-6772-5130-a774-d5fcae4a789d"))
platforms = [Pkg.Artifacts.unpack_platform(e, "LAME", artifacts_toml) for e in artifacts["LAME"]]
...
if best_platform === nothing
    @debug("Unable to load LAME; unsupported platform $(triplet(platform_key_abi()))")
else
